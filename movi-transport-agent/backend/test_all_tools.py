...
Comprehensive Tool Testing Suite for Movi Transport Agent
...
class TestLogger:
    ...
    def print_summary(self):
        ...
        print("\n" + "="*80)
        print("MOVI TRANSPORT AGENT - COMPREHENSIVE TOOL TEST RESULTS")
        print("="*80)
...
async def test_agent_query(query: str, session_id: str) -> Dict[str, Any]:
    ...
    async with httpx.AsyncClient(timeout=90.0) as client:  # Increased from 30s to 90s for slower LLM responses
...
if __name__ == "__main__":
    print("\n" + "="*80)
    print("MOVI TRANSPORT AGENT - COMPREHENSIVE TOOL TESTING SUITE")
    print("="*80)
